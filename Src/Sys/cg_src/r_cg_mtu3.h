...
#define _06_MTU_PCLK_256                (0x06U) /* Internal clock: counts on PCLK/256 (for MTU1 only) */
#define _05_MTU_PCLK_1024               (0x05U) /* Internal clock: counts on PCLK/1024 (for MTU3,4,6,7,8) */
#define _07_MTU_PCLK_1024               (0x07U) /* Internal clock: counts on PCLK/1024 (for MTU2 only) */
...
***********************************************************************************************************************/
/* TGRA1 value */
#define _270F_TGRA1_VALUE               (0x270FU)
/* TGRB1 value */
#define _144F_TGRB1_VALUE               (0x144FU)
/* TGRA4 value */
#define _270F_TGRA4_VALUE               (0x270FU)
/* TGRB4 value */
#define _270F_TGRB4_VALUE               (0x270FU)
/* TGRC4 value */
#define _270F_TGRC4_VALUE               (0x270FU)
/* TGRD4 value */
#define _270F_TGRD4_VALUE               (0x270FU)
