...
Macro definitions
***********************************************************************************************************************/
#define _83_DMAC7_ACTIVATION_SOURCE                      (0x83U)        /* DMAC7 activation source select */
#define _00000000_DMAC7_SRC_ADDR                         (0x00000000UL) /* DMAC7 source address */
#define _00000000_DMAC7_DST_ADDR                         (0x00000000UL) /* DMAC7 destination address */
#define _00000001_DMAC7_DMCRA_COUNT                      (0x00000001UL) /* DMAC7 transfer count in Normal/Repeat mode
                                                                           or block size count in Block mode */
#define _0000_DMAC7_SRC_EXT_RPT_AREA                     (0x0000U)      /* DMAC7 source address extended repeat area */
#define _0000_DMAC7_DST_EXT_RPT_AREA                     (0x0000U)      /* DMAC7 destination address extended repeat area */
...
static void r_dmac7_callback_transfer_end(void);
