...
Macro definitions
***********************************************************************************************************************/
#define _F5_IIC2_SCL_HIGH_LEVEL_PERIOD               (0xF5U) /* SCL clock high-level period setting */
#define _FF_IIC2_SCL_LOW_LEVEL_PERIOD                (0xFFU) /* SCL clock low-level period setting */
...
MD_STATUS R_RIIC2_Master_Send_Without_Stop(uint16_t adr, uint8_t * const tx_buf, uint16_t txnum);
...
static void r_riic2_callback_receiveend(void);
void r_riic2_transmitend_interrupt(void);
void r_riic2_error_interrupt(void);
